import type { APIEmbed, APIGuildInteraction, APIGuildMember, APIUser, Permissions } from 'discord-api-types/v8';
...
export async function createHistory(
	...
	member: APIGuildMember & { user: APIUser; permissions: Permissions },
) {
